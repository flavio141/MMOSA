...
from models import MixtureOfExperts
...
def train_test_moma(args, train_loader, val_loader, writer, cv, device):
    ...
    model = MixtureOfExperts(input_size=1536, dropout=0.4)
    model.to(device)
    ...
    for epoch in range(args.epochs):
        ...
        for train_sample in train_loader:
            ...
            del risk, features, demog, clin, genomic, transcr, real_time, event_indicator, masking
        ...
        with torch.no_grad():
            ...
            for val_sample in val_loader:
                ...
                del features_val, demog_val, clin_val, genomic_val, transcr_val, real_times_val, event_indicator_val, masking_val, eval_risk
                torch.cuda.empty_cache()
